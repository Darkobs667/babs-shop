...
export function AddToCart({ product }: { product: { id: string; name: string; price: string; imageUrl?: string; variants: Variant[] } }) {
  ...
  const available = product.variants.length === 0 || Boolean(variant && variant.stock > 0);
